...
**Repository:** `Secrets-Kit` · **CLI:** `seckit` · **Current pre-release:** `v2.0.0a1` (`dev` branch)
...
Issues, testing reports, documentation fixes, architecture discussion, and pull requests are welcome.
...
- [GITHUB_RELEASE_BUILD.md](docs/GITHUB_RELEASE_BUILD.md)

## Support the project

If Secrets-Kit is useful to you and you want to support ongoing development:
