...
from secrets_kit.cli.parsers.internal import register_internal_commands
...
from secrets_kit.cli.parsers.peer import register_peer_commands
from secrets_kit.cli.parsers.rss import register_rss_commands
...
from secrets_kit.cli.parsers.status import register_status_command
from secrets_kit.cli.parsers.taxonomy import register_taxonomy_commands
from secrets_kit.cli.parsers.transaction import register_transaction_commands
from secrets_kit.cli.parsers.uninstall import register_uninstall_command
from secrets_kit.cli.parsers.upgrade import register_upgrade_command
...
def build_parser() -> argparse.ArgumentParser:
    ...
    register_daemon_commands(subparsers=subparsers)
    register_envelope_commands(subparsers=subparsers)
    register_transaction_commands(subparsers=subparsers)
    ...
    register_rss_commands(subparsers=subparsers)
    ...
    register_upgrade_command(subparsers=subparsers)
    register_uninstall_command(subparsers=subparsers)
    register_info_command(subparsers=subparsers)
    register_status_command(subparsers=subparsers)
