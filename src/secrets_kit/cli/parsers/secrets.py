...
def register_secret_commands(
    *,
    ...
    p_set.add_argument("--type", help=msg("cli.secrets.type_help_text"))
    p_set.add_argument("--kind", help=msg("cli.secrets.kind_help_text"))
    p_set.add_argument("--schema-id", help=msg("cli.secrets.schema_id_help_text"))
