...
def register_schema_commands(*, subparsers: argparse._SubParsersAction) -> None:
    ...
    remove_parser.add_argument("--backend", choices=list(BACKEND_CHOICES))
    ...
    deprecate_parser.add_argument("--backend", choices=list(BACKEND_CHOICES))
    ...
    remove_schema.add_argument("--backend", choices=list(BACKEND_CHOICES))
