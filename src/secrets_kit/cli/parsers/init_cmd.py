...
def register_init_commands(
    *, subparsers: argparse._SubParsersAction[argparse.ArgumentParser]
    ...
    p_init.add_argument("--backend", choices=list(BACKEND_CHOICES), help=argparse.SUPPRESS)
    p_init.add_argument("--unsafe-plaintext-storage", action="store_true", help=argparse.SUPPRESS)
    ...
    p_init_sqlite.add_argument("--unsafe-plaintext-storage", action="store_true", help=argparse.SUPPRESS)
