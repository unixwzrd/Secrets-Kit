...
def register_import_commands(
    *,
    ...
    p_import_env.add_argument(
        "--names",
        help=msg("cli.import_cmd.names_help_text"),
    )
    p_import_env.add_argument("--type", choices=["secret", "pii"])
    p_import_env.add_argument("--kind", help=msg("cli.import_cmd.kind_help_text"))
    ...
    p_import_file.add_argument("--kind", help=msg("cli.import_cmd.kind_help_text"))
