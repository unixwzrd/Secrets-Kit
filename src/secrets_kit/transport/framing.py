...
The frame codec is intentionally independent of Unix sockets, TCP sockets,
TLS, routing envelopes, and storage backends.
"""
...
def frame_json(obj: Mapping[str, Any] | Any) -> bytes:
    """Serialize to canonical UTF-8 JSON and prefix with uint32 big-endian length."""
