...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_import_env = import_sub.add_parser("env", parents=[common])
    ...
    p_import_file = import_sub.add_parser("file")
    ...
    p_migrate_dotenv = migrate_sub.add_parser("dotenv", parents=[common])
