...
- [Metadata schema registry](#metadata-schema-registry)
  - [Not the same as entry type, kind, or tags](#not-the-same-as-entry-type-kind-or-tags)
  - [Authority](#authority)
  - [Descriptor shape (v1)](#descriptor-shape-v1)
  - [Registry document](#registry-document)
  - [Merge rules (`schema install`)](#merge-rules-schema-install)
  - [Metadata merge on writes](#metadata-merge-on-writes)
  - [CLI](#cli)
...
- `node_identity` — minimal local node JSON reserved for synchronization identity
...
See also: [TAXONOMY.md](TAXONOMY.md) for entry type/kind/tag vocabulary, which is separate from this document.
