...
- [CLI style guide — Secrets Kit](#cli-style-guide--secrets-kit)
  - [Command taxonomy and compatibility](#command-taxonomy-and-compatibility)
  - [JSON output stability](#json-output-stability)
  - [Help verbosity and examples](#help-verbosity-and-examples)
  - [Cross-platform wording](#cross-platform-wording)
  - [Safe defaults messaging](#safe-defaults-messaging)
  - [Error wording classes](#error-wording-classes)
  - [Shared argparse helpers](#shared-argparse-helpers)
  - [Tests and dynamic help](#tests-and-dynamic-help)
...
- **Keychain-specific** wording belongs mainly on **`unlock`**, **`lock`**, **`info`** (macOS), and capability explanations (e.g. **`doctor`**), not scattered across every subcommand.
...
For disclosure levels, authority/index separation, and backend posture, see [SECURITY_MODEL.md](SECURITY_MODEL.md) and [CLI_ARCHITECTURE.md](CLI_ARCHITECTURE.md).
